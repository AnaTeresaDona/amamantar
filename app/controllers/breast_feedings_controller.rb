class BreastFeedingsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @breast_feeding.save
        format.html { redirect_to @breast_feeding, notice: 'El registro fue creado exitosamente' }
  ...
  def update
    respond_to do |format|
      if @breast_feeding.update(breast_feeding_params)
        format.html { redirect_to @breast_feeding, notice: 'El registro fue actualizado exitosamente' }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to breast_feedings_url, notice: 'El registro fue eliminado exitosamente.' }
